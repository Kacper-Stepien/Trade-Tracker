...
import { formatPercentage, toFiniteNumberOrNull } from "../utils/number";
...
export default function DashboardPage() {
  ...
  return (
    <AsyncStateBoundary
      data={stats}
      isLoading={isStatsLoading || isProductsLoading}
      isError={isStatsError || isProductsError}
    ...
    >
      {(resolvedStats) => {
        ...
        const realizedMarginColor =
          (resolvedStats.soldProductsProfitPercentage ?? 0) >= 0
            ? PRODUCT_STATUS_COLORS.sold
            : PRODUCT_STATUS_COLORS.loss;
        ...
        const sellThroughRate =
          resolvedStats.numberOfProducts > 0
            ? (resolvedStats.numberOfSoldProducts / resolvedStats.numberOfProducts) * 100
            : null;
        const averageDaysFromPurchaseToSaleRaw =
          resolvedStats.averageDaysFromPurchaseToSale;
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            >
              <KpiCard
                ...
                value={resolvedStats.numberOfProducts}
                ...
                value={
                  <Box display="flex" alignItems="baseline" gap={1.5}>
                    <Typography variant="h6" fontWeight={700} sx={{ color: profitColor }}>
                      {formatPrice(resolvedStats.totalProfit, i18n.language)}
                    </Typography>
                    {resolvedStats.totalProfitPercentage !== null ? (
                      <Typography
                        variant="body2"
